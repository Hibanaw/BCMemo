...
void homepage()
{
    ...
    while (1)
    {
        ...
        tw = text_newDefault("ÓÃ»§Ãû¹ý¶Ì", 715, 380, 1000, 430);
        tw.font.fontColor = _RED;
        tw1 = text_newDefault("ÃÜÂë¹ý¶Ì", 740, 460, 1050, 510);
        tw1.font.fontColor = _RED;
        tc1 = text_newDefault("»¶Ó­µÇÂ¼£¡", 650, 510, 1050, 560);
        tc1.font.fontColor = _RED;
        tc2 = text_newDefault("ÃÜÂë´íÎó", 740, 460, 1050, 510);
        tc2.font.fontColor = _RED;
        tc3 = text_newDefault("×¢²á³É¹¦", 740, 460, 1050, 510);
